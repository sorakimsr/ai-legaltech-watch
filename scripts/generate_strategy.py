...
- **굵게 강조(`**...**`)는 "의미론적으로 의사결정에 직결되는 구절"에만 적용**:
  - 강조해야 할 것 (✅ 의미·영향력·시사점·행동 지침):
    ...
    "성공한 목표당 비용으로 KPI를 재설계", "온프레미스 요구가 도입 속도를 제한", "벤더 종속이 풀린다",
    "내재화 vs 외부 플랫폼 구독 결정 시점", "협상 레버리지가 옮겨갔다"
  - 강조 금지 (❌ 단순 고유명사·수치·기관명):
    예시) "OpenAI", "Anthropic", "Sequoia Capital", "수출입은행", "KB금융", "Harvey", "Mike OSS",
    "40억 달러", "110억 달러", "Pre-Litigation-as-a-Service", "AWS 서밋 서울"
  - 회사명·금액·기법명은 본문에 그대로 적되 강조하지 말 것. 강조는 "왜 의미 있는가/그래서 무엇을 해야 하는가"의 해석·시사 구절에만.
  - body·action 합쳐 한 카드당 강조는 3~5개 정도로 절제. 한 문장에 1~2개 이내.
- 5~7개 사이
