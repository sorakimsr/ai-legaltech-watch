...
- **카드 정렬 — 중요도 순 (v6.15.20)**: cards 배열의 **1번 카드가 가장 의사결정 영향력이 큰 것, 마지막 카드가 상대적으로 덜 중요한 것**.
  ...
  **★★ 코버리지 의무**: 위 6개 AI×법조 주제군 중 데이터에 등장한 주제는 **반드시 별도 카드로 다뤄야 한다**.
  같은 빌드 내에서 판결문 공개 기사 1건 + AI 규제 기사 2건이 있다면, 두 주제를 통합하지 말고 **각각 1장씩** 카드를 만들어라.
  산업 trend 카드 갯수보다 AI×법조 카드 갯수가 적은 응답은 품질 미달.
