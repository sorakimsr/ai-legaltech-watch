...
[응답 형식 — JSON 객체]
{{
  "summary": "{period_label} 핵심 흐름을 2~3문장(150~220자)으로 압축. 카드들 전체를 관통하는 메타 줄거리 — '이런 큰 흐름들이 동시에 일어나고 있으며 가장 결정적인 한 가지는 X다' 같은 구조. **summary 안에서도 가장 결정적인 1~2개 인사이트 구절을 `**...**`로 강조하라** (예: '**거버넌스 설계 역량이 AI 도입의 실질적 병목**으로 부상'). 시점 표현 금지.",
  "cards": [
    {{
      "tag": "TREND 01 · [한 줄 주제]",
      "title": "[20~35자 헤드라인]",
