...
[
  {{
    "tag": "TREND 01 · [한 줄 주제]",
    "title": "[20~35자 헤드라인]",
    "body": "[4~5문장, 250~450자. 핵심 키워드(회사명·제품명·금액·기법명·차별화 포인트)는 **굵게** 마크다운으로 표시. (1) 어떤 흐름이 관찰되는가 (구체 회사명·제품명·금액·날짜) (2) 왜 이게 한국 실무자에게 의미가 있는가 (3) 표면적 해석이 아닌 그 아래 깔린 시장 구조·역학 (4) 이 흐름이 향후 어디로 갈 가능성이 큰가. 일반론·교과서적 표현 금지. 한 줄 짜리 단정형 절대 금지.]",
    "action": "[2~3문장, 150~280자. 핵심 동작·지표·키워드는 **굵게** 마크다운으로 표시. 명사형 종결 금지(예: '~수립.', '~검토.' X). 동사형·서술형으로 '~한다', '~하자', '~해보면 좋다' 식으로 구체 동작을 적는다. (1) 첫 단계로 무엇을 한다 (2) 그 다음 무엇을 검증하거나 만든다 (3) 어떤 지표·기준으로 성공·실패를 판단한다 — 이 셋 중 최소 둘을 포함. **시점 표현 절대 금지(지금 당장 / 즉시 / 이번 주 안에 / 이번 달 내 / 빠른 시일 내 / 우선 / 곧 등 일체 사용 금지)**.]",
    "sources": [번호1, 번호2, ...]
  }},
  ...
]
...
- 핵심 키워드·문구는 `**굵게**` 마크다운으로 표시. 단 한 문장당 1~2개만. 과도한 강조 금지.
- 5~7개 사이
