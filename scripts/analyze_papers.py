...
{{
  "narrative": "최근 흐름을 한국 전략·기획 담당자 관점에서 풀어쓴 분석. 마크다운 형식, 800~1500자 (충분히 길게, 풍부하게). 핵심 키워드(회사명·기법명·차별화 포인트)는 **굵게** 마크다운으로 강조. 다음 구조 권장:\\n\\n## 한 줄 요약\\n(이번 {period_label}을(를) 한 문장으로)\\n\\n## 1) 무엇이 부상하고 있는가\\n구체 논문/주제 2~3개를 회사명·기법명 그대로 인용하면서 풀어 설명. 핵심 키워드는 **굵게**. 연구자용 용어는 한국어로 풀어쓰기 (예: 'retrieval-augmented generation' → '검색-증강 생성·RAG').\\n\\n## 2) 한국 실무자에게 이 흐름이 무슨 의미인가\\n전략·기획 담당자가 '아 그래서 어떻게 해야 하지'를 떠올릴 수 있도록 구체 사례로 풀어쓰기.\\n\\n## 3) 산업 적용 흐름\\n어떤 분야(법률·금융·제조·콘텐츠 등)에 먼저 들어올 가능성이 높은가, 한국 기업이 채택 시 어떤 제약(개인정보·국외이전·on-prem 요구)이 있을 가능성이 있는가.",
  "hot_topics": [
    {{"topic": "주제명 (한국어 풀어쓴 표현 + 영문 병기)", "description": "한 줄 설명 — 한국 전략·기획자가 이해할 수 있는 평이한 표현. 핵심 키워드는 **굵게**.", "paper_count": 정수, "paper_indices": [실제 해당 논문의 위 목록 인덱스 번호들]}}
  ],
  "key_techniques": [
    {{"technique": "기법명 (한국어 풀어쓴 표현 + 영문 병기)", "description": "한 줄 설명 — '왜 이 기법이 중요한가'를 한국 실무자 관점에서. 핵심 키워드는 **굵게**.", "paper_count": 정수, "paper_indices": [실제 해당 논문의 위 목록 인덱스 번호들]}}
  ],
  "actionable_insights": [
    "실무자가 본인 업무에 바로 시도해볼 수 있는 구체 시사점. 핵심 키워드는 **굵게**. 시점 표현(지금 당장 / 즉시 / 이번 주 / 이번 달 등) 금지.",
    "시사점 2 — 다른 관점/주제",
    "시사점 3 — 다른 관점/주제",
...
- 핵심 키워드는 `**굵게**` 마크다운으로 표시. 단 과도한 강조 금지 (한 문장당 1~2개).
