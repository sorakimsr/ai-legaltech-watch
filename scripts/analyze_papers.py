...
{{
  "narrative": "최근 흐름을 한국 전략·기획 담당자 관점에서 풀어쓴 분석. 800~1500자, 4~5개 단락으로 구성된 자연스러운 평문. **마크다운 헤더(#, ##, ###) 사용 금지**. 구조는 (1) 한 문장 요약, (2) 무엇이 부상하고 있는가 (구체 논문·주제 2~3개 회사명·기법명 그대로 인용), (3) 한국 실무자에게 이 흐름이 무슨 의미인가 (구체 사례로), (4) 산업 적용 흐름과 한국 기업이 채택 시 제약. 각 단락은 빈 줄로 분리. 단락의 첫 문장이 그 단락의 주제를 명확히 드러내도록 작성.",
  "hot_topics": [
