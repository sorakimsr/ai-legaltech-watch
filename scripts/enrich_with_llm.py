...
# v2.7.1: 모든 영문 뉴스 → summary_ko + insight_ko 둘 다 (threshold 무관)
#         핵심 문구/키워드는 **굵게** 마크다운으로 표시 → UI에서 형광 하이라이트
...
규칙:
- 핵심 사실(회사명·금액·날짜·핵심 기술명·차별화 포인트)에는 **굵게** 표시. 예: **OpenAI**가 **40억 달러** 규모로...
- 한 문장당 1~2개 키워드만 강조. 과도한 강조 금지.
- '시사점:' 같은 접두어 없이 본문만.
...
{{
  "summary_ko": "2~3문장. 핵심 사실 중심. 80~150자. 단정 어조 지양. 핵심 키워드는 **굵게**.",
  "insight_ko": "1~2문장. 본인 업무에 적용할 액션 가능한 시사점. 60~120자. 핵심 키워드는 **굵게**."
}}
"""
...
규칙:
- 핵심 문구/키워드(회사명·기술명·차별화 포인트)는 **굵게** 마크다운으로 표시.
- 한 문장당 1~2개 키워드만 강조.
- 시점 표현(지금 당장 / 이번 주 안에 / 이번 달 내 / 즉시 등) 사용 금지.
